...
5.  اگر می‌خواهید پروفایل کاربری شما از طریق ایمیل و شماره‌تلفن قابل جست‌وجو نشود گزینه‌های Profile discovery using email address و Profile discovery using phone number را محدود کنید.
