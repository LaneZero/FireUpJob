...
### قسمت Summery
در قسمت Profile اگر یک مقداری به پایین اسکرول کنید گزینه Add a Summery را مشاهده می‌کنید.
می‌توانید قسمت Summery رزومه خود را در اینجا استفاده کنید، اگر سابقه کار بالایی دارید توضیحات را به‌صورت داستان‌وار هم می‌توانید بنویسید و شرایطی که در کار و حرفه خود با آن مواجه شده‌اید را توضیح دهید. از هوش‌های مصنوعی مثل ChatGPT یا claude.ai برای ساخت توضیحات می‌توانید کمک بگیرید.
