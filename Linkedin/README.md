...
اضافه کردن رزومه در آینده اگر کاری را از لینکدین بخواید انتخاب کنید خودکار از رزومه شما استفاده می کند.
...
برای اینکه متوجه بشویم وضعیت حقوق برای شغلی که میخواهیم چقدر است باید از قسمت Salary لینکدین استفاده کنیم.
