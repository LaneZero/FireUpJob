...
### ایجاد Connection
در لینکدین، سه سطح اصلی کانکشن «First»، «Second» و «Third» وجود دارد. اما منظور از این سطح‌ها چیست؟.

در سطح «First» من به یک نفر درخواست کانکشن می‌دهم و فرد مقابل، این درخواست را قبول می‌کند. با این کار، فردی که درخواست من را قبول کرده است در سطح یک کانکشن‌های من قرار می‌گیرد؛ یعنی من او را فالو کرده‌ام و او هم من را فالو کرده است. تا اینجای کار، تقریبا با سازوکاری مشابه شبکه‌های اجتماعی دیگر روبه‌رو هستیم.

ماجرای کانکشن‌های سطح دوم، کمی متفاوت است. اجازه بدهید این مورد را با یک مثال برایتان روشن کنم. تصور کنید من با فردی به نام «علی» کانکشن برقرار می‌کنم. با این کار، علی در سطح یک کانکشن‌های من قرار می‌گیرد. علی آقای ماجرای ما خودش با 200 نفر دیگر کانکشن دارد که تمام آن 200 نفر، می‌شوند کانکشن‌های سطح دوم من. به زبان ساده، یعنی دوستِ دوستِ من می‌شود، کانکشن «Second» من.

ماجرای کانکشن‌های «Third» هم در ادامه همین کانکشن‌های «Second» رخ می‌دهد. تصور کنید یکی از آن 200 نفری که با علی کانکشن سطح یک داشتند «نازنین» نام داشته باشد. این نازنین خانم با فرد دیگری به نام «الهام» کانکشن سطح یک دارد. اما کانکشن من و الهام خانم در سطح سوم قرار می‌گیرد و می‌شود «Third» کانکشن.

جالب این است که کانکشن‌های خانم الهام «third plus» یا «out of network» هستند و ارتباط من با آنها خیلی دور است. در واقع، اگر از بالا به کانکشن‌ها نگاه کنیم، شکل و شمایل یک هرم را به خود می‌گیرند.برای درک بیشتر موضوع تصویر زیر که مربوط به دوره جامع لینکدین مارکتینگ است را برای شما آوردیم.
